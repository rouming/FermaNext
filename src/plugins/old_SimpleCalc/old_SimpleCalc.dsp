...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "(QTDIR)\include" /I "..\..\FermaNext" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OLD_SIMPLECALC_EXPORTS" /D "QT_THREAD_SUPPORT" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "$(QTDIR)\include" /I "..\..\FermaNext" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OLD_SIMPLECALC_EXPORTS" /D "QT_THREAD_SUPPORT" /YX /FD /GZ /c
...
# ADD LINK32 qt-mt332.lib qtmain.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /out:"../../../plugins/old_SimpleCalc.dll" /pdbtype:sept /libpath:"$(QTDIR)\lib"
