...
# ADD LINK32 "TrussUnit.lib" "common.lib" "$(QTDIR)\lib\QtCore4.lib" "$(QTDIR)\lib\QtGui4.lib" "$(QTDIR)\lib\QtNetwork4.lib" /nologo /dll /incremental:yes /machine:IX86 /nodefaultlib:"libc" /out:"..\..\..\plugins\old_SimpleCalc.plg.dll" /libpath:"..\..\..\build\debug" /libpath:"$(QTDIR)\lib"
