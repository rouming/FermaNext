...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "$(QTDIR)\include" /I "..\..\TrussUnit" /I "..\..\common" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OLD_SIMPLECALC_EXPORTS" /D "QT_THREAD_SUPPORT" /YX /FD /c
...
# ADD LINK32 qt-mt.lib qtmain_rel.lib common.lib TrussUnit.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /machine:I386 /out:"../../../plugins/old_SimpleCalc.dll" /libpath:"../../../build" /libpath:"$(QTDIR)\lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(QTDIR)\include" /I "..\..\TrussUnit" /I "..\..\common" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OLD_SIMPLECALC_EXPORTS" /D "QT_THREAD_SUPPORT" /YX /FD /GZ /c
